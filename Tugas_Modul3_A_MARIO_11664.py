...
st.markdown("""
        ...
        """, unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1664</h1>", unsafe_allow_html=True)
st.markdown("""<p style='text-align: center; color: #0073e6;'>Aplikasi ini berguna untuk memprediksi IPK berdasarkan nilai Matematika,
            Bahasa Inggris, dan Bahasa Indoensia</P>""", unsafe_allow_html=True)
